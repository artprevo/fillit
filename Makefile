...
#    Updated: 2019/01/03 22:11:09 by artprevo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c ft_opti.c ft_backtracking.c ft_delete.c ft_array.c ft_list.c ft_fill.c ft_ini.c parsing.c ft_safejoin.c
HEADERS = ./includes
